...
class DQN(object):
    ...
    def train(self):
        for episode in range(self.num_episodes):
            ...
            print("Episode {0:02}/{1}".format(this_episode, self.num_episodes))
            if this_episode % 100 == 0:
                self.model.save("models/{0}_{1:04d}.h5".format(self.model_name, this_epoch))
